...
public abstract class BaseQuartzJob implements Job {
    ...
    /**
	 * Delegate the actual job execution to
	 * {@link BaseQuartzJob#executeInternal(JobExecutionContext)} method which must
	 * be overridden by subclasses. The method actually extracts the Spring
	 * {@link ApplicationContext} and allows a convenience method
	 * {@link BaseQuartzJob#getBean(String)} to return a Spring Initialized Bean.
	 * 
    ...
    /**
	 * Utility method to extract a Spring Bean from the Spring
	 * {@link ApplicationContext} that is supplied in the Quartz
	 * {@link JobExecutionContext}. The method is parameterized to use dynamic
	 * typing.
	 * 
	 * @param <T>
	 *            the bean type
	 ...
	 *            
	 * @param clazz
	 *            the {@link Class} type of bean to get
	 * 
	 * @return the bean instance
	 */
