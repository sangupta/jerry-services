...
/**
 * Test various entity types like {@link CreationTimeStampedEntity}, {@link UpdateTimeStampedEntity}, 
...
public class DataStoreServiceEntityTypesTest {
    ...
    private static class CreationTimeTestObject implements CreationTimeStampedEntity {
        @Id
        String id;
        long created;
    ...
    private static class UpdateTimeTestObject implements UpdateTimeStampedEntity {
        ...
        @Override
        public void setUpdated(long creationTime) {
